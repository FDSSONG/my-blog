...
![Snipaste_2025-11-03_19-40-18](./image/Spring/Snipaste_2025-11-03_19-40-18.png)
...
![Snipaste_2025-11-10_22-01-13](./image/Spring/Snipaste_2025-11-10_22-01-13.png)


而在Spring程序设计中，IOC 是有专门的容器去控制对象。

![Snipaste_2025-11-10_22-01-51](./image/Spring/Snipaste_2025-11-10_22-01-51.png)
...
```
## 1.9如果让你设计一个SpringIoc，你觉得会从哪些方面考虑这个设计？
...
![Snipaste_2025-11-10_22-06-31](./image/Spring/Snipaste_2025-11-10_22-06-31.png)


## 1.11 SpringAOP的原理了解吗
Spring AOP的实现依赖于动态代理技术。动态代理是在运行时动态生成代理对象，而不是在编译时。它允许开发者在运行时指定要代理的接口和行为，从而实现在不修改源码的情况下增强方法的功能。
...
![Snipaste_2025-11-10_22-12-43](./image/Spring/Snipaste_2025-11-10_22-12-43.png)
...
## 1.17 spring是如何解决循环依赖的？
循环依赖指的是两个类中的属性相互依赖对方：例如 A 类中有 B 属性，B 类中有 A属性，从而形成了一个依赖闭环，如下图。



![Snipaste_2025-11-10_22-13-51](./image/Spring/Snipaste_2025-11-10_22-13-51.png)
