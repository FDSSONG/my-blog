...
![Snipaste_2025-10-29_23-11-50](./image/MySQL/Snipaste_2025-10-29_23-11-50.png)
...
![Snipaste_2025-10-29_23-23-52](./image/MySQL/Snipaste_2025-10-29_23-23-52.png)
...
RankedStudents AS (
    SELECT
        stu_id,
        total_score,
        # 表示排名依据是总分，命名为ranking，Rank（）是SQL窗口函数，表示每行数据在结果中的排名
...
## 如何用 MySQL 实现一个可重入的锁？
可重入锁是允许同一个线程多次获取同一把锁的锁机制。当线程已经持有该锁时，请求该锁不会被阻塞，而是会直接成功，只需记录获取次数，最后释放相应次数释放该锁。

可重入锁的适用场景：1.递归调用场景：递归的每一层都需要获取该锁。递归计算目录大小。2.嵌套调用：A调用B，B也需要该锁。3.同一线程连续执行需要加锁的多个任务。
...
# 存储引擎
## 执行一条SQL请求的过程是什么？
先来一个上帝视角图，下面就是 MySQL 执行一条 SQL 查询语句的流程，也从图中可以看到 MySQ 内部架构里的各个功能模块。

![Snipaste_2025-10-30_15-51-42](./image/MySQL/Snipaste_2025-10-30_15-51-42.png)
...
![Snipaste_2025-10-30_15-56-07](./image/MySQL/Snipaste_2025-10-30_15-56-07.png)
...
![Snipaste_2025-10-30_15-58-53](./image/MySQL/Snipaste_2025-10-30_15-58-53.png)
...
![Snipaste_2025-10-30_16-07-04](./image/MySQL/Snipaste_2025-10-30_16-07-04.png)
...
![Snipaste_2025-10-30_16-13-39](./image/MySQL/Snipaste_2025-10-30_16-13-39.png)
...
![Snipaste_2025-10-30_16-20-14](./image/MySQL/Snipaste_2025-10-30_16-20-14.png)
...
![Snipaste_2025-10-30_16-25-02](./image/MySQL/Snipaste_2025-10-30_16-25-02.png)
...
![Snipaste_2025-10-30_16-27-04](./image/MySQL/Snipaste_2025-10-30_16-27-04.png)
...
![Snipaste_2025-10-30_16-30-28](./image/MySQL/Snipaste_2025-10-30_16-30-28.png)
...
![Snipaste_2025-10-30_16-31-47](./image/MySQL/Snipaste_2025-10-30_16-31-47.png)
...
![Snipaste_2025-10-30_16-34-45](./image/MySQL/Snipaste_2025-10-30_16-34-45.png)
...
![Snipaste_2025-10-30_16-37-25](./image/MySQL/Snipaste_2025-10-30_16-37-25.png)
...
![Snipaste_2025-10-30_16-38-27](./image/MySQL/Snipaste_2025-10-30_16-38-27.png)
...
![Snipaste_2025-10-30_16-59-29](./image/MySQL/Snipaste_2025-10-30_16-59-29.png)
...
![Snipaste_2025-10-30_17-00-46](./image/MySQL/Snipaste_2025-10-30_17-00-46.png)
...
![Snipaste_2025-10-30_17-02-02](./image/MySQL/Snipaste_2025-10-30_17-02-02.png)
...
![Snipaste_2025-10-30_17-06-08](./image/MySQL/Snipaste_2025-10-30_17-06-08.png)
...
![Snipaste_2025-10-30_17-08-21](./image/MySQL/Snipaste_2025-10-30_17-08-21.png)
...
![Snipaste_2025-10-30_17-10-42](./image/MySQL/Snipaste_2025-10-30_17-10-42.png)
...
![Snipaste_2025-10-30_17-11-50](./image/MySQL/Snipaste_2025-10-30_17-11-50.png)
...
![Snipaste_2025-10-30_17-12-46](./image/MySQL/Snipaste_2025-10-30_17-12-46.png)
...
![Snipaste_2025-10-30_17-14-21](./image/MySQL/Snipaste_2025-10-30_17-14-21.png)
...
![Snipaste_2025-11-01_22-36-50](./image/MySQL/Snipaste_2025-11-01_22-36-50.png)
...
![Snipaste_2025-11-01_22-38-16](./image/MySQL/Snipaste_2025-11-01_22-38-16.png)
...
![Snipaste_2025-11-01_22-40-09](./image/MySQL/Snipaste_2025-11-01_22-40-09.png)
...
![Snipaste_2025-11-01_22-41-15](./image/MySQL/Snipaste_2025-11-01_22-41-15.png)
...
![Snipaste_2025-11-01_22-44-01](./image/MySQL/Snipaste_2025-11-01_22-44-01.png)
...
![Snipaste_2025-11-01_22-46-12](./image/MySQL/Snipaste_2025-11-01_22-46-12.png)
...
![Snipaste_2025-11-01_22-49-38](./image/MySQL/Snipaste_2025-11-01_22-49-38.png)
...
![Snipaste_2025-11-01_22-50-14](./image/MySQL/Snipaste_2025-11-01_22-50-14.png)
...
![Snipaste_2025-11-01_22-50-38](./image/MySQL/Snipaste_2025-11-01_22-50-38.png)
...
![Snipaste_2025-11-01_22-52-38](./image/MySQL/Snipaste_2025-11-01_22-52-38.png)
...
![Snipaste_2025-11-01_22-57-10](./image/MySQL/Snipaste_2025-11-01_22-57-10.png)
...
![Snipaste_2025-11-01_22-58-23](./image/MySQL/Snipaste_2025-11-01_22-58-23.png)
...
## 分表和分库是什么？有什么区别？
![Snipaste_2025-11-01_22-59-35](./image/MySQL/Snipaste_2025-11-01_22-59-35.png)
...
![Snipaste_2025-11-01_23-00-25](./image/MySQL/Snipaste_2025-11-01_23-00-25.png)
